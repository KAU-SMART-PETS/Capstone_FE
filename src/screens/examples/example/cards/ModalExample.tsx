...
export const ModalType1: React.FC<ModalWindowProps> = ({ visible, setVisible, galleryHandler, cameraHandler }) => {
  ...
  const GalleryButton = (
    <RoundedTextButton
      ...
      widthOption="lg"
      color="bg-primary"
      onPress={handleButtonPress(galleryHandler)}
    />
  );
  ...
  const CameraButton = (
    <RoundedTextButton
      ...
      widthOption="lg"
      color="bg-primary"
      onPress={handleButtonPress(cameraHandler)}
    />
  );
